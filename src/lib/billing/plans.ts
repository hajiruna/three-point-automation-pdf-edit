...
export const PLANS: Record<PlanType, PlanDefinition> = {
  free: {
    ...
    limits: {
      pdfExtractionsPerMonth: 50,
      pdfMergesPerMonth: 25,
      maxPagesPerOperation: 250,
      maxFilesPerMerge: 5,
    },
    features: [
      'PDF page extraction (50/month)',
      'PDF merging (25/month, up to 5 files)',
      'Up to 250 pages per operation',
      'Basic support',
    ],
    featuresJa: [
      'PDFページ抽出（月50回）',
